                  ...
                  <div class="product-nav-wrapper row">
                    <div class="col-lg-4 col-md-5">
                      <ul class="nav product-filter-nav">
                        <li class="active"><a href="#">TO RECEIVED ORDERS</a></li>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content modal-content-demo">
          <div class="modal-header">
            <h6 class="modal-title">RATE PRODUCT</h6>
          ...
          <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
                   <center><div class="my-rating-5"></div></center>
          ...
          <!-- <div class="modal-footer">
            ...
            <button type="button" class="btn btn-outline-light" id="UpdateCategory">Rate</button>
          </div> -->
        </div>
      </div><!-- modal-dialog -->
    </div><!-- modal -->
...
function ReceivedOrder(order_id, product_id) {

    if(confirm('Already Received this order?') == false) {
       return false;
    }

    $.post('<?= base_url('Home/OrderReceived') ?>',{order_id: order_id},(response) => {
      if(response.msg == 'success') {
        swal.fire('Orders Successfully Completed!', '', 'success');
        GetOrders();
...
function GetOrders() {
      $.post('<?= base_url('Home/GetOrders') ?>',{status: 'Approved'},(result) => {
              ...
              var tr = $(`
                <tr>
                    ...
                    <td width="15%" align="center">
                       <button class="btn btn-outline-primary" onclick="ReceivedOrder(${row.OrderID},${row.ProducID})">ORDER RECEIVED</button>
                    </td>
                </tr>
              `);
    ...
    function SaveRating(rate) {
       ...
       $.post('<?=base_url('Home/SaveRating') ?>', {rate: rate, product_id: $('#product_id').val()}, function(result) {
           if(result.msg == 'success') {
            swal.fire('Thankyou for rating :)', '', 'success');
