...
function GetOrders() {
      $.post('<?= base_url('Home/GetOrders') ?>',{status: 'Pending'},(result) => {
          ...
          result.forEach((row) => {
              var tr = $(`
                <tr>
                    ...
                    <td width="15%" align="center"><button class="btn btn-outline-danger" onclick="Cancel(${row.OrderID})">Cancel</button></td>
                </tr>
              `);
