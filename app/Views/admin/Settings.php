    ...
    <div class="container-fluid">
         <br><br>
          <div class="row">
              ...
              <ul class="list-group">
                <li class="list-group-item"><a href="<?= base_url('Admin/Settings') ?>" class="nav-link">Profile</a></li>
                <li class="list-group-item"><a href="<?= base_url('Admin/ChangePassword') ?>" class="nav-link">Change Password</a></li>
              </ul>
