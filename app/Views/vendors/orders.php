...
function ApprovedOrder(order_id) {
  ...
  $.post('<?= base_url('Vendor/GetUserOrdersById') ?>',{order_id: order_id},(result) => {
    result.forEach((row) => {
...
function GetOrders(status = 'All') {
      $.post('<?= base_url('Vendor/GetUserOrders') ?>',{status: status},(result) => {
              ...
              var tr = $(`
                <tr>
                    ...
                    <td width="20%" align="center">
                      ...
                      ${row.Status == 'Pending' ? `
                        <button class="btn btn-outline-danger" onclick="Cancel(${row.OrderID})"><span class="fas fa-thumbs-down"></span></button>
                        <button class="btn btn-outline-success" onclick="ApprovedOrder(${row.OrderID})"><span class="fas fa-thumbs-up"></span></button>
                        ` : ''}
 ...
 $(function() {
  ...
  $('#btn_approved_order').click(function() {
    $.post('<?= base_url('Vendor/ApprovedOrder') ?>',{order_id: $('#v_order_id').val()},(response) => {
