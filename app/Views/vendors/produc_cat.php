    ...
    <div class="az-content pd-y-20 pd-lg-y-30 pd-xl-y-40">
      <div class="container">
        <div class="az-content-body pd-lg-l-40 d-flex flex-column">
          ...
          <div class=" card">
              <div class=" card-body">
                    <button class="btn btn-outline-success" id="AddCategory">Add Category <span class="fas fa-plus"></span></button>
                    <br><br>
        ...
        <div class="modal-content modal-content-demo">
          ...
          <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
                     <label>Category Name</label>
                     <input type="text" class="form-control" id="u_cat_name">
...
<script>
 ...
 function DeleteCategory(CategoryID) {
    ...
    $.post('<?= base_url('Vendor/DeleteCategory') ?>', {CategoryID: CategoryID}, function(result) {
              ...
              var tr = $(`
                <tr>
                    ...
                    <td align="center" width="15%">
                        <button class="btn btn-outline-primary" onclick="UpdateCategory('${row.Name}',${row.CategoryID})"><span class="fas fa-pencil-alt"></span></button>
                       <button class="btn btn-outline-danger" onclick="DeleteCategory(${row.CategoryID})"><span class="fas fa-trash"></span></button>
                    </td>
                </tr>
              `);
 ...
 $(function() {
    ...
    GetCategory();
     ...
     $('#SaveCategory').click(function() {
         ...
         $.post('<?= base_url('Vendor/AddCategory') ?>', {cat_name: $("#cat_name").val()}, function(result) {
           if(result.msg == 'success') {
     ...
     $('#UpdateCategory').click(function() {
        ...
        if($("#u_cat_name").val() == '') {
         ...
         $.post('<?= base_url('Vendor/UpdateCategory') ?>', {cat_name: $("#u_cat_name").val(), cat_id: $('#u_cat_id').val()}, function(result) {
           if(result.msg == 'success') {
